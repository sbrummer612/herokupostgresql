This instance is ready for heroku deployment, it required a postgresql add on

Maven
Postgresql (jdbc:postgresql://localhost:5432/postgres or heroku postgres instance)
Spring Data JPA
